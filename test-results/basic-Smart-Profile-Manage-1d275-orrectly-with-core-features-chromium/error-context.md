...
- Name: basic.spec.ts >> Smart Profile Management System E2E >> Landing page loads correctly with core features
- Location: tests\basic.spec.ts:8:3
...
Locator: getByText(/CCIS Smart Faculty Profile Management System/i)
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByText(/CCIS Smart Faculty Profile Management System/i)
