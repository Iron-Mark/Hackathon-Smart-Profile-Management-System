...
- Name: basic.spec.ts >> Authentication and Basic Routing >> login page loads correctly
...
Locator: getByText(/sign in|log in/i).first()
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByText(/sign in|log in/i).first()
