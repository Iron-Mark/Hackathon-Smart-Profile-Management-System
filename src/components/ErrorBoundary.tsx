    ...
    if (this.state.hasError) {
      ...
      return (
        <div className="flex h-screen w-screen flex-col items-center justify-center bg-background text-center text-foreground p-6">
          <AlertTriangle className="h-16 w-16 text-red-600 mb-4 dark:text-red-300" />
          ...
          {process.env.NODE_ENV === "development" && (
            <pre className="mt-6 p-4 bg-muted rounded text-left text-sm text-red-700 overflow-auto max-w-2xl w-full dark:text-red-300">
