  ...
  if (!file) {
    return (
      <main className="min-h-screen bg-slate-50 flex items-center justify-center px-4">
        <section className="max-w-lg w-full rounded-lg border bg-white p-6 shadow-sm">
          <FileText className="w-10 h-10 text-slate-500 mb-4" />
          <h1 className="text-2xl font-semibold text-slate-900">Demo File Unavailable</h1>
      ...
      <section className="mx-auto max-w-4xl px-4 py-8">
        <div className="mb-6 flex items-center justify-between gap-4">
          <div>
            ...
            <h1 className="text-3xl font-semibold text-slate-900">Demo File Preview</h1>
        ...
        <div className="rounded-lg border bg-white p-5 shadow-sm">
          {isImage && file.dataUrl ? (
            <img
              src={file.dataUrl}
              alt={file.name}
              className="max-h-[65vh] w-full rounded-md object-contain bg-slate-100"
            />
          ) : (
            <div className="flex min-h-80 flex-col items-center justify-center rounded-md border border-dashed bg-slate-50 text-center">
              {isImage ? (
          ...
          <dl className="mt-5 grid gap-3 text-sm text-slate-700 sm:grid-cols-2">
            <div>
              <dt className="font-medium text-slate-900">Bucket</dt>
              <dd>{file.bucket}</dd>
            </div>
            <div>
            ...
            <div>
              <dt className="font-medium text-slate-900">Stored path</dt>
