...
- Name: essential.spec.ts >> Smart Profile Management System - Essential Flows >> Login page renders and can be interacted with
- Location: tests\essential.spec.ts:14:3
...
Locator: getByPlaceholder(/email|example/i).first()
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByPlaceholder(/email|example/i).first()
